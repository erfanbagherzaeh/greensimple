...
import flower02 from '../../public/image/flower02.jpg'
import flower03 from '../../public/image/flower03.webp'
import flower04 from '../../public/image/flower04.png'
function Shopping(){
    return(
        <>
        <Navbar></Navbar>
        <div className="img-bg w-[100vw] h-[650px] bg-lime-500 flex flex-row justify-center items-center">
            <div className="w-[550px] h-[200px]  flex flex-col items-center">
...
کنید به ایده های جدید خود طراوت اضافه کنید
        ...
        <div className="w-full h-auto  flex flex-wrap justify-center mt-10">
            <div className="mt-2 mb-2 w-[250px] h-[250px] border rounded-lg bg-slate-200 flex flex-col items-center mx-2">
                <div className="w-[85%] h-[80%] bg-orange-400 rounded-lg mt-1">
                    <Image className="w-[100%] h-[100%]" src={flower01} alt=""></Image>
                </div>
                <div>
            ...
            <div className="mt-2 mb-2 w-[250px] h-[250px] border rounded-lg bg-slate-200 flex flex-col items-center mx-2">
                <div className="w-[85%] h-[80%] rounded-lg bg-orange-400 mt-1">
                    <Image className="w-[100%] h-[100%]" src={flower02} alt=""></Image>
                </div>
                <div>
                    <button className="bt1 mt-2"> خرید</button>
                </div>
            ...
            <div className="mt-2 mb-2 w-[250px] h-[250px] border rounded-lg bg-slate-200 flex flex-col items-center mx-2">
                <div className="w-[85%] h-[80%] rounded-lg bg-orange-400 mt-1">
                    <Image className="w-[100%] h-[100%]" src={flower03} alt=""></Image>
                </div>
                <div>
                    <button className="bt1 mt-2"> خرید</button>
                </div>
            ...
            <div className="mt-2 mb-2 w-[250px] h-[250px] border rounded-lg bg-slate-200 flex flex-col items-center mx-2">
                <div className="w-[85%] h-[80%] rounded-lg bg-orange-400 mt-1">
                    <Image className="w-[100%] h-[100%]" src={flower04} alt=""></Image>
                </div>
                <div>
                    <button className="bt1 mt-2"> خرید</button> 
                </div>
        ...
        <div className='w-full h-[800px] my-20 md:h-[220px]'>
            <div className='w-3/5 h-full  m-auto flex border-2 rounded-lg'>
                <div className='w-[100%] h-full  md:w-[100%]'>
                    <p style={{fontSize:'18px'}} className='text-white p-8'>لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است، و برای شرایط فعلی تکنولوژی مورد نیاز، و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد، کتابهای زیادی در شصت و سه درصد گذشته حال و آینده، شناخت فراوان جامعه و متخصصان را می طلبد، تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی، و فرهنگ پیشرو در زبان فارسی ایجاد کرد، در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد.</p>
                </div>
            </div>
        </div>
