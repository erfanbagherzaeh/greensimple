...
کنید به ایده های جدید خود طراوت اضافه کنید
        ...
        <div className='w-full h-auto flex flex-wrap  flex-col p-2'>
            <div className='w-[80%] h-auto border border-green-950 bg-lime-950 rounded-lg m-auto flex flex-row flex-wrap justify-center'>
        ...
        <div className='w-full h-[280px] my-20 md:h-[254px]'>
            <div className='w-[80%] h-full  m-auto flex border-2 rounded-lg'>
                <div className='w-[100%] h-full  md:w-[60%]'>
